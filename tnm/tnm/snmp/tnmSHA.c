...
void TnmSHAInit(SHA_CTX *sha_info)
{
...
void TnmSHAUpdate(SHA_CTX *sha_info, BYTE *buffer, int count)
{
    int i;
    LONG clo;
...
void TnmSHAFinal(unsigned char digest[20], SHA_CTX *sha_info)
{
    int count;
...
void sha_stream(unsigned char digest[20], SHA_CTX *sha_info, FILE *fin)
{
    int i;
